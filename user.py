...
user_daniel.enroll()
# specified amout to be spent for gold card
user_daniel.spend_points(50)
user_daniel.display_info()
...
user_luis.display_info()
user_luis.enroll()
user_luis.display_info()
# specified amout to be spent for gold card
user_luis.spend_points(80)
user_luis.display_info()   
...
user_doris.display_info()
user_doris.enroll()
user_doris.display_info()
# specified amout to be spent for gold card
user_doris.spend_points(100)   
user_doris.display_info()